export const Fichas = [
  {
    ...
    fichaTecnica: {
      ...
      Aplicación: [
        {
          'Modo de Acción': 'Es de acción sistémica, estomacal y de contacto.',
        },
        {
          'Mecanismo de Acción':
            'El Thiarnethixam posee una marcada actividad sistémica en raíces ,tallos y hojas, mostrando una rápida acción por contacto e ingestión sobre las plagas sensibles. Su absorción es rápida; penetra en el interior de la semilla tratada y en cuanto esta germina se dirige hacia los organos en crecimiento, y protege la plantula y posterior desarrollo del cultivo. Actúa como agonista de la acetilcolina en el sistema nervioso',
        },
        {
          Cultivos:
            'Maíz, arroz, frijol, algodón, papa, soya, girasol, pastos.',
        },
  ...
  {
    id: 2,
    nombreProducto: 'Fitobolic®',
    Categoría: 'Bioestimulantes',
    fichaTecnica: {
      'Descripción del Producto': [
        {'Nombre Comercial': 'Fitobolic®'},
        {
          'Formulación y Concentración': 'Matería orgánica de origen vegetal',
        },
        {'Tipo de Agroinsumo': 'Regulador de crecimiento no sintético'},
        {Categoría: 'Bioestimulantes'},
        {
          'Grupo Químico':
            'Productos naturales,aminoácidos, compuestos de Magnesio, Manganeso, Boro, Hierro y Zinc',
        },
      ],
      'Detalles del Producto': [
        {'pH de la Formulación': '4.0 a 5.0 (al 10%)'},
        {Color: 'Café claro'},
  ...
  },
  {
    ...
    fichaTecnica: {
      'Descripción del Producto': [
        {'Nombre Comercial': 'Biokim Diazinon 60 EC'},
        {
          Presentación:
            'Emulsión Concentrada. Cada litro de producto comercial contiene 600 gramos de ingrediente activo.',
        },
      ...
      'Aplicación del Producto': [
        ...
        {
          Cultivos:
            'Arroz, Banano, Cebolla, Café, Cítricos, Frijol, Maíz, Piña, Sorgo, Melón, Sandia',
        },
        {
          Dosis:
        ...
        {
          Compatibilidad:
            'Incompatible con fungicidas a base de cobre, fertilizantes a base de calcio, no mezclar con propanil.',
        },
        {Presentación: '250cc, 500cc, 1.0L, 3.5L, 20L, 200L'},
        {
          'Clasificación Toxicológica':
            'II Moderadamente Peligroso. Franja Amarilla',
        },
      ],
    },
  },
  {
    id: 4,
    nombreProducto: 'Renova 25 WG',
    Categoría: 'Insecticida',
    fichaTecnica: {
      'Descripción del Producto': [
        {'Nombre Comercial': 'Renova 25 WG'},
        {
          'Formulación y Concentración':
      ...
      'Aplicación del Producto': [
        {
          'Modo de Acción': 'Insecticida de contacto, estomacal y sistémico. ',
        },
        {
          'Mecanismo de Acción':
        ...
        {
          Cultivos:
            'Arroz, Tomate, Chile, Berenjena, Fresa, Melón, Sandia, Pepino, Ayote, Chayote, Tabaco, Caña de Azúcar, Algodón',
        },
        {Dosis: '50 - 400 gramos/ha, según el cultivo'},
        {
          Compatibilidad:
            'RENOVA 25 WG es compatible con la mayoría de los insecticidas y fungicidas comúnmente usados.',
        },
  ...
  },
  {
    ...
    fichaTecnica: {
      'Descripción del Producto': [
        {'Nombre Comercial': 'Circular Extra 28 Sc'},
        {
          'Formulación y Concentración':
  ...
  {
    id: 6,
    nombreProducto: 'Evito 48 SC',
    Categoría: 'Fungicida',
    fichaTecnica: {
      'Descripción del Producto': [
        {'Nombre Comercial': 'Evito® 48 SC'},
        {
          Presentación: '1 litro, 100 mL',
        },
        {'Ingrediente Activo': 'Fluoxastrobin'},
        {Categoría: 'Fungicida'},
        {
          'Grupo Químico': 'Dihydro dioxazinas',
        },
      ],
      'Detalles del Producto':
  ...
  {
    id: 8,
    nombreProducto: 'Affix 50 WG',
    Categoría: 'Fungicida',
    fichaTecnica: {
      'Descripción del Producto': [
        {'Nombre Comercial': 'Affix 50 WG'},
        {
          'Formulación y Concentración':
      ...
      'Aplicación del Producto': [
        {
          'Modo de Acción':
            'Fungicida de amplio espectro, con acción sistémico-translaminar, se utiliza de forma preventiva, curativa y anti-esporulante.',
        },
        {
          'Mecanismo de Acción':
            'Actúa inhibiendo de la respiración mitocondrial en el hongo, al evitar la transferencia de electrones entre el citocromo b y el citrocromo c',
        },
        {
          Cultivos:
        ...
        {
          Compatibilidad:
            'Incompatible con algunos coadyuvantes y con insecticidas foliares de formulados como concentrados emulsionables.',
        },
        {'Presentaciones de': '500 gramos y 100 gramos'},
        {
          'Clasificación Toxicológica':
      ...
      'Enfermedades que controla': [
        ...
        {'Escaldado de la hoja': 'Rhynchosporium sp'},
        {'Mancha marrón': 'Helminthosporium oryzae'},
    ...
    dosis: '350ml/Barril',
    casa: 'BASF',
    imagen: require('../../assets/Productos/AFFIX_50WG​.png'),
    beneficios: [
      'Época de floración a fructificación.',
      'Es absorbido por la hoja teniendo efecto traslaminar.',
      'Inhibición de la germinación de las zoosporas y esporangios, desarrollo micelial y esporulación del hongo.',
    ],
  },
  {
    id: 9,
    nombreProducto: 'Terminal 15 SL',
    Categoría: 'Herbicida',
    fichaTecnica: {
      'Descripción del Producto': [
        {'Nombre Comercial': 'Terminal 15 SL'},

        {
          'Formulación y Concentración':
            'Solución liquida (SL). Cada litro de producto comercial contiene 150 gramos de ingrediente activo.',
        },
        {'Ingrediente Activo': 'Glufosinato de Amonio'},
        {Categoría: 'Herbicida'},
        {'Grupo Químico': 'Acido fosfónico'},
      ],
      'Aplicación del Producto': [
        {
          'Modo de Acción':
            'Herbicida de contacto no selectivo, post-emergente a la maleza.',
        },
        {
          'Mecanismo de Acción':
        ...
        {
          'Clasificación Toxicológica': 'Banda Verde',
        },
      ],
      'Enfermedades que controla': [
        {
        ...
        {Coyolillo: 'Cyperus spp'},
        {Coyolillo: 'Cyperus rotundus'},
        {Lechilla: 'Euphorbia sp'},
        {Moriseco: 'Bidens pilosa'},
        {'Zacate Grama': 'Paspalum spp'},
  ...
  },
  {
    ...
    fichaTecnica: {
      'Descripción del Producto': [
        {'Nombre Comercial': 'BIOQUIM OXATE 24 SL'},
        {'Formulación y Concentración:': 'Solución líquida al 24% p/v'},
        {'Ingrediente Activo:': 'Oxamil 24%'},
        {'Categoria:': 'Insecticida-Nematicida'},
        {'Grupo Químico': ' Carbamato'},
      ],
      'Aplicacion del Producto:': [
        {
          'Modo de Accion:':
            'Oxate 24 SL es un insecticida-nematicida sistémico y de contacto. Puede aplicarse al suelo y al follaje para el control de insectos y nemátodos; para los insectos al momento de la aplicación actúa por contacto; con efecto residual moderado, no volátil. Dentro de la planta se mueve por xilema y floema.',
        },
        {
          'Mecanismo de acción:':
        ...
        {
          'Compatibilidad:':
            'Es compatible con la mayoría de insecticidas y fungicidas usados; sin embargo, se recomienda hacer pruebas de compatibilidad. No mezclar con productos de reacción alcalina ni con compuestos a base de cobre y hierro.',
        },
        {'Presentación:': 'Litros'},
        {'Clasificación Toxicológica:': 'Áltamente peligroso, Banda Roja'},
      ],

      'tabla#tabla-Enfermedades que controla/Dosis de Aplicación': {
        ...
        rows: [
          ...
          [
            'Café, Coffea arábica',
            'Nemátodos: Melaidoqyne spp, Pratylenchus spp',
            'Aplicación foliar de 2-5 litros/ha ó 1.5-4.0 litros/manzana',
          ],
          [
            'Piña, Ananas comosus',
            'Nemátodos: \nMelaidoqyne spp\nPratylenchus spp\nRorylenchulus reniformis',
            'Aplicación foliar de 2-5 litros/ha ó 1.5-4.0 litros/manzana\nTratamiento pre-plantacion: 8-12 litros\nAplicación total al suelo una semana antes del transpante.\nAplicación foliar 2-6 litros/ha (1.5-4 litros /manzana)\nIntérvalos de Aplicación 4 semanas.',
          ],
        ],
      },
    },
  },
  {
    ...
    fichaTecnica: {
      'Descripción del Producto': [
        ...
        {
          'Formulación y Concentración':
            'Gránulos dispersables, 70%, equivalente a 700 g i.a/Kg',
        },
        {'Ingrediente Activo': 'Amicarbazone'},
        {Categoría: 'Herbicida'},
        {'Grupo Químico': 'Triazolinas'},
      ],
      'Detalles del Producto': [
        {'Presentación:': 'Bolsa de 1 Kilogramo'},
        {'pH de la Formulación:': '5.20 de la solución al 5%'},
        {'Aspecto y Color:': 'Granulado fino de color beige'},
        {'Solubilidad en Agua': '4,600 mg/l'},
      ],
      'Aplicación del Producto:': [
        {
          'Modo de Acción:':
        ...
        {
          'Modo de Aplicación:':
            'Se recomienda su aplicación en forma terrestre o aérea, ya sea con equipo manual (bombas de mochila) o equipo impulsado por un tractor en un volumen de mezcla de 200 a 300 litros/ha o con equipo aéreo en un volumen de 27 a 54 litros de mezcla/ha. Para su correcta aplicación y cobertura se recomienda utilizar boquilla de abanico plano 8002/8003 o su equivalente.',
        },
        {
          'Clasificación Toxicológica':
            'III: Banda Toxicológica Azul; Productos poco peligrosos.',
        },
        {
          'Compatibilidad:':
        ...
        {
          Fitotoxicidad:
            'DINAMIC 70 WG, no es fitotóxico a las dosis recomendadas.',
        },
        {
  ...
  },
  {
    ...
    fichaTecnica: {
      'Descripción del Producto': [
        ...
        {Categoría: 'Bioestimulante'},
        {'Grupo Bioquímico': 'Ácidos Orgánicos'},
      ],
      'Detalles del Producto': [
        {'Presentación:': 'Frasco 160g: 10g'},
        {'pH de la Formulación': '6.0 a 8.5 (solución al 5%)'},
        {Color: 'Blanco'},
      ...
      'Aplicación del Producto:': [
        {
          'Modo de Acción:':
            'BIOGIB Es un estimulante de crecimiento vegetal hecho a base de ácido giberélico (GA₂) que favorece el crecimiento vegetativo mediante la división y/o elongación celular, en las regiones meristemáticas, promoviendo el desarrollo y crecimiento de la planta. Induce el amarre y crecimiento de frutos.',
        },
        {
          Compatibilidad:
            'BIOGIB* 10PS, es compatible con la mayoría de los agroquímicos, se sugiere hacer las aplicaciones durante el crecimiento de frutos.',
        },
        {'Clasificación Toxicológica': 'Ligeramente Tóxico'},
      ],

      'tabla#tabla-Enfermedades que controla/Dosis de Aplicación': {
        headers: ['Cultivos', 'Dosis y Épocas', 'Efectos'],
        rows: [
          [
          ...
          [
            'Uva Superior',
            '100 gramos de BIOGIB® 10 PS por ha en una aplicación de 800 a 1,000 l/ha dos semanas después del raleo natural con un diámetro de baya de 10 a 15 mm.',
            'Aumenta el tamaño de la baya y reduce el adelgazamiento de esta.',
          ],
          [
            'Uva Thompson sin semilla',
            'De 40 a 80 gramos de BIOGIB® 10 PS por ha antes de la floración cuando los racimos tengan un largo de 8 a 13 cm. De 160 a 400 gramos de BIOGIB® 10 PS por ha después del raleo del racimo cuando las bayas midan de 4 a 5 mm de diámetro o dos aplicaciones de igual cantidad, la primera dentro de 2 a 3 días después del raleo haciendo la segunda aplicación dentro de las dos próximas semanas.',
            'Alargamiento de los racimos y reducción del costo de raleo. Aumento de tamaño en uvas y racimos',
          ],
        ],
      },
    },
  },
  {
    ...
    fichaTecnica: {
      'Descripción del Producto': [
        ...
        {
          'Formulación y Concentración':
            'Solución acuosa. Agente acidificante y fosfato de alcohol tridecilico etoxilado',
        },
        {
          'Ingrediente Activo':
            'Agente Acidificante, Alcohol Tridecílico Etoxilado, Dietilenglicol',
        },
        {Categoría: 'Coadyuvante'},
        {'Grupo Químico': 'Surfactantes etoxilados no iónicos, Fosfatos'},
      ],
      'Aplicación del Producto': [
        {
          'Modo de Acción':
            'Los agentes acidificantes de Biofase-1* reducen y amortiguan el pH del agua alcalina. La fórmula contiene un indicador que cambia de color de acuerdo al pH de la solución, permitiendo ajustarlo al valor deseado dentro de un rango de 4 a 6.5; de esta forma se evita la descomposición que sufren las agroquimicas por hidrólisis alcalina. Biofase-1* ayuda a la compatibilidad de concentrados emulsionables con fertilizantes foliares alcalinos. Biofase-1 contiene un agente surfactante no iónico que rompe la tensión superficial del agua permitiendo mayor dispersión de la gota para un máximo cubrimiento, también se mejora la humectación y penetración de la solución de aplicación, asegurando una mayor eficiencia del producto aplicado. Biofase-1 contiene además, un agente majante de tipo glicol que mantiene húmeda la película de aplicación una vez que el agua se ha evaporado evitando que las partículas de los plaguicidas sólidos caigan o sean retiradas por el viento.',
        },
        {
          Compatibilidad:
            'Este producto es compatible con todas las agroquimicas. Se recomienda hacer una pequeña prueba de compatibilidad antes de proceder a su mezcla con otros materiales.',
        },
        {Presentación: 'Jarra 10 LT, Litros'},
        {'pH de la Formulación': '0.5 a 1.5 (dilución al 10%)'},
      ],
      'Indicaciones y Dosis': [
        'Mezcle el producto en el agua de aspersión antes de agregar otros agroquímicos y calcule la dosis requerida siguiendo este procedimiento:',
      ...
      'Composición Química': [
        {
          'Composición Química % P/V':
            'Abamecticin (BSI, draf E-ISO ANSI); Abamecticin (f) draf F-ISO: 1,8 Ingredientes Inertes: 98,2 Total: 100',
        },
      ...
      'Aplicación del Producto:': [
        ...
        },
        {
          'Método de Aplicación:':
            'Agregue la cantidad necesaria de ABALÓN 1.8 CE al tanque rociador medio lleno y agite mientras agrega el agua restante. Aplicar el producto inmediatamente después de mezclar.',
        },
        {
          'Compatibilidad:':
        ...
        {
          'Fitocoxicidad:':
            'Puede ser fitotóxico para las frutas de pepita cuando se mezcla con captan.',
        },
      ],
      'tabla#tabla-Usos y Dosis de Aplicación': {
        headers: [
          'Cultivos y Plagas',
          'Dosis',
  ...
  },
  {
    ...
    fichaTecnica: {
      ...
      'Aplicación del Producto': [
        ...
        {
          'Modo de Acción':
            ' Balear 72 SC es un fungicida protectante de amplio espectro, que inhibe la respiración de las células del hongo.',
        },
        {
          'Método de Aplicación:':
  ...
  {
    id: 22,
    nombreProducto: 'NPK FERTIL 30.6-0-0+8.9S',
    fichaTecnica: {
      'Descripción del Producto': [
  ...
  },
  {
    ...
    fichaTecnica: {
      ...
      'Recomendaciones de Uso': ['Fórmula cafetalera de llenado, alta en Potasio y considerablemente alta en Nitrógeno, es una fórmula balanceada, con las materias primas mas comunes, el cual la hace ser más económica y por lo tanto mas accesible para los productores poco innovadores'],
    },
  },
  {
    id: 27,
    ...
    fichaTecnica: {
      ...
      'Recomendaciones de Uso': ['Fertilizante granular recomendado para el cultivo de papa en su primera etapa de crecimiento, potencializado con liberación controlada que permite una mejor eficiencia del Nitrógeno hasta por 3 meses'],
    },
  },
  {
    id: 28,
    ...
    fichaTecnica: {
      ...
      'Recomendaciones de Uso': ['Fertilizante granular recomendado especialmente para café en su última etapa de llenado de grano para obtener maduraciones uniformes, buen tamaño de grano y buen peso, potencializado con liberación controlada que permite una mejor eficiencia del nitrógeno hasta por tres meses'],
    },
  },
  {
    id: 29,
    nombreProducto: 'Redox 4X4 30(CaO3)+8(MgO)+16(S)+9(SiO2)',
    fichaTecnica: {
      'Descripción del Producto': [
        {'Nombre Comercial': 'Redox 4X4 30(CaO3)+8(MgO)+16(S)+9(SiO2)'},
        {'Clase de Producto': 'Calcio, Magnesio, Azufre, Silicio'},
        {'Tipo Formulación': 'Polvo Micronizado'},
        {'Categoría Toxicológica': 'Producto Mineral no Tóxico'},
        {'Número de Registro Honduras:': '2002/361-66-IV'},
      ],
      'Propiedades del Producto': [
        {Aspecto: 'Polvo'},
      ...
      'Recomendaciones de Uso': ['Es una fórmula que aporta cuatro nutrientes, tiene una alta efectividad para corregir el PH del suelo y neutralizar elementos como aluminio, fierro y manganeso.'],
    ],
    'tabla#tabla-Beneficios Directos que aporta REDOX 4x4': {
      headers: ['Beneficios Directos que aporta REDOX 4x4',],
      rows: [
        ['1. Fuente de nutrientes: Calcio, Magnesio, Azufre y Silicio.'],
        ['2. Corrector de acidez de manera rápida y efectiva.'],
        ['3. Favorece las reacciones de neutralización para la captura y el desplazamiento del Aluminio a las capas inferiores del suelo.'],
        ['4. Mejora la saturación de bases intercambiables (Ca-Mg) a nivel de la solución de suelo'],
      ],
    },
  },
  {
    ...
    fichaTecnica: {
      ...
      'Recomendaciones de Uso': ['Fertilizante granular recomendado especialmente para plantaciones adultas, así como también para el cultivo del plátano, potencializado con liberación controlada que permite una mejor eficiencia del Nitrógeno hasta por tres meses.'],
    },
  },
  {
    id: 31,
  ...
  },
  {
    ...
    fichaTecnica: {
      ...
      'Recomendaciones de Uso': ['Fórmula convencional para el cultivo de café en producción para la etapa de inicio (fertilización mayo), esta fórmula es una propuesta comercial, dado a la relación N/K 1/1, es de mantenimiento y con un nivel medio de fósforo y un aporte de elementos secundarios como Magnesio y Calcio.'],
    },
  },
  {
    id: 34,
    ...
    fichaTecnica: {
      ...
      'Recomendaciones de Uso': ['Fórmula convencional para el cultivo de café en producción para la etapa de inicio (Fertilización Mayo). Esta fórmula es una propuesta comercial, dado a la relación N/K 1/1, es de mantenimiento y con un nivel mínimo de fósforo. Con aporte de Calcio y Zinc.'],
    },
  },

  {
    id: 35,
    nombreProducto: 'NPK FERTIL 20-3-18-3.0 CaO-1.4MgO',
    fichaTecnica: {
      'Descripción del Producto': [
      ...
      'Recomendaciones de Uso': ['Fertilizante granular, mezcla física de NPK en proporciones iguales, usada en cultivos demandantes de altos contenidos de Nitrógeno, Fósforo y Potasio.'],
    },
  },
  {
    id: 36,
    ...
    fichaTecnica: {
      'Descripción del Producto': [
        ...
        {'Clase de Producto': 'Fertlizante Sólido Granulado'},
        {'Tipo Formulación': 'Fertilizante Granulado para uso Agrícola'},
        {'Categoría Toxicológica': 'N/A'},
        {'Número de Registro Honduras:': '2002/361-66-IV'},
      ],
      ...
      'Recomendaciones de Uso': ['Fertilizante granular recomendado para los primeros dos años de establecimiento del cultivo de café o para otros cultivos perennes, potencializado con liberación controlada que permite una mejor eficiencia de Nitrógeno hasta por tres meses.'],
    },
  },
  {
    id: 37,
    nombreProducto: 'NPK FERTIL 18.7-0-20',
    fichaTecnica: {
      'Descripción del Producto': [
      ...
      'Recomendaciones de Uso': ['Fertilizante granular, mezcla física de N-K-S, en proporciones 1-0-1.1-0.38 MgO, para ser utilizada en aplicaciones en el cultivo de banano y con ello suplir las demandas requeridas de nutrientes según requerimiento de cliente.'],
    },
  },
  {
    id: 38,
    nombreProducto: 'MAKROSOL 20-20-20 TOP',
    fichaTecnica: {
      'Descripción del Producto': [
        {'Nombre Comercial': 'MAKROSOL 20-20-20 TOP'},
        {'Clase de Producto': 'Mezcla física Soluble'},
        {'Tipo Formulación': 'Fertilizante Soluble para uso Agrícola'},
        {'Categoría Toxicológica': 'N/A'},
        {'Número de Registro Honduras:': '2002/361-66-IV'},
      ],
      'Propiedades del Producto': [
        {Aspecto: 'Cristales Sólidos'},
        {'Estabilidad a la Luz': 'Estable'},
        {Densidad: 'N/A'},
        {Corrosividad: 'N/A'},
  ...
  },
  {
    ...
    fichaTecnica: {
      ...
      'Recomendaciones de Uso': ['Fertilizante granular recomendado para el cultivo de palma en la etapa de producción. Así como también para aquellos cultivos demandantes de potasio en sus ultimos dias de llenado, potencializado con liberación controlada que permite una mejor eficiencia del Nitrógeno hasta por tres meses.'],
    },
  },
  {
    id: 40,
    ...
    fichaTecnica: {
      ...
      'Recomendaciones de Uso': ['Fertilizante granular, mezcla fpisica de N-K-S, en proporciones 1-0-1.5-0.15S, para ser utilizada en aplicaciones en el cultivo de banano y con ello suplir demandas requeridas de nutrientes según requerimiento de cliente.'],
    },
  },
  {
    id: 41,
  ...
  },
  {
    ...
    fichaTecnica: {
      ...
      'Recomendaciones de Uso': ['Fertilizante granular recomendado para el cultivo de papa en la etapa de aporque, potencializado con liberación controlada que permite una mejor eficiencia del Nitrógeno hasta por tres meses.'],
    },
  },
  {
    id: 43,
    ...
    fichaTecnica: {
      ...
      'Recomendaciones de Uso': ['Fertilizante granular recomendado especialmente para hacer mezclas físicas o para recuperación de pastizales dañados por sobre pastoreo, potencializado con liberación controlada que permite una mejor eficiencia del Nitrógeno hasta por 3 meses.'],
    },
  },
  {
    id: 44,
    ...
    fichaTecnica: {
      ...
      'Recomendaciones de Uso': ['Fórmula convencional y balanceada para el cultuivo de café en etapa de inicio, es económica para el productor ya que solo contiene cinco elementos en su composición: Nitrógeno, Fósforo, Potasio, Calcio y Magnesio, contiene un 5% de fósforo debido a las deficiencias de este momento a nivel de país, por lo tanto, es necesario un balance que pueda aportar lo necesario al cultivo para un buen desarrollo del mismo.'],
    },
  },
  {
    id: 45,
    ...
    fichaTecnica: {
      ...
      'Recomendaciones de Uso': ['Fertilizante de Propósito general recomendado para una amplia gama de cultivos especialmente frutales, hortalizas y ornamentales, potencializado con liberación controlada que permite una mejor eficiencia del nitrógeno hasta por tres meses.'],
    },
  },
  {
    id: 46,
    ...
    fichaTecnica: {
      ...
      'Recomendaciones de Uso': ['Fórmula balanceada en porciones equitativas, para la utilización en cultivos con demandas elevadas de contenidos Nitrógeno y Fósforo, orientada para uso en las etapas de crecimiento, desarrollo y mantenimiento sano de un cultivar.'],
    },
  },
  {
    id: 47,
    ...
    fichaTecnica: {
      'Descripción del Producto': [
        ...
        {'Clase de Producto': 'Fertilizante Sólido Granulado'},
        {'Tipo Formulación': 'Fertilización Granulado para uso Agrícola'},
        {'Categoría Toxicológica': 'N/A'},
        {'Número de Registro Honduras:': '2002/361-66-IV'},
      ],
      'Propiedades del Producto': [
      ...
      'Recomendaciones de Uso': ['Fertilizante granulado diseñado para aplicación a todo tipo de cultivos, frutales, forestales, flores y hortalizas que aporta los macronutrientes más importantes: Nitrógeno, Fósforo y Potasio en la mezcla. Es el fertilizante de la línea que suministra NPK rápidamente disponible por las plantas.'],
    },
  },
  {
    id: 48,
  ...
  },
  {
    ...
    fichaTecnica: {
      ...
      'Recomendaciones de Uso': ['Fertilizante granular recomendado para el cultivo de palma en la etapa de producción asi como también para aquellos cultivos demandantes de potasio en sus ultimos dias de llenado, potencializado con liberación controlada que permite una mejor eficiencia del Nitrógeno hasta por tres meses.'],
    },
  },
  {
    id: 50,
    ...
    fichaTecnica: {
      ...
      'Recomendaciones de Uso': ['Fertilizante granular recomendado para el cultivo de palma en la etapa de producción asi como también para aquellos cultivos de demandantes de potasio en sus últimos dias de llenado, potencializado con liberación controlada que permite una mejor eficiencia del Nitrógeno por tres meses.'],
    },
  },
  {
    id: 51,
    nombreProducto: 'BELLIS 38 WG',
    fichaTecnica: {
      'Descripción del Producto': [{'Nombre Comercial': 'BELLIS 38 WG'}],
    },
    dosis: '200ml/Barril',
    casa: 'BASF',
    Categoría: 'Fungicida',
    ...
    beneficios: [
      'Control simultaneo de mildeo polvoso y Botrytis.',
      'Manejo anti resistencia.',
      'Mayor productividad y calidad de la cosecha.',
